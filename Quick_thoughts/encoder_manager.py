...
from Quick_thoughts import s2v_encoder
...
class EncoderManager(object):
    ...
    def load_model(self, model_config, uniform_init_scale, input_file_pattern,
                   shuffle_input_data, input_queue_capacity,
                   num_input_reader_threads, batch_size, dropout,
                   dropout_rate, context_size):
    ...
    """
        ...
        g = tf.Graph()
        with g.as_default():
            encoder = s2v_encoder.s2v_encoder(model_config, uniform_init_scale,
